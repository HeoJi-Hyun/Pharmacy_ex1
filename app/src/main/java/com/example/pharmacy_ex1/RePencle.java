...
public class RePencle extends AppCompatActivity{
    // 로그에 사용할 TAG 변수 선언
...
// 이때 ListActivity 의 onResume() 함수 가 호출되며, 데이터를 새로 고침
                Toast.makeText(RePencle.this, "등록되었습니다.", Toast.LENGTH_SHORT).show();
                finish();
            }else
            {
                Toast.makeText(RePencle.this, result, Toast.LENGTH_SHORT).show();
            }
