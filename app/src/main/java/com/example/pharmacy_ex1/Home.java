...
public class Home extends AppCompatActivity
    ...
    Button btnala, btnprov, btnchek, btnpharm, btnmemo, btnMy;
    EditText memo;
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                //현재 위치에 마커 생성하고 이동
                //이거현재위치로안돌아오게하는거임setCurrentLocation(location, markerTitle, markerSnippet);
    ...
    public void setDefaultLocation() {
        ...
        //디폴트 위치, Seoul
        LatLng DEFAULT_LOCATION = new LatLng(37.58, 127.06);
    ...
    public void onRequestPermissionsResult(int permsRequestCode,
        ...
        //위에 onRequestPermissionsResult 빨간줄떠서 댓글보고 추가함
    ...
    public void showPlaceInformation(LatLng location)
    {
        ...
        new NRPlaces.Builder()
                .listener(Home.this)
                .key("AIzaSyCC1r6-RA6MEgbOmVA9OdhUVIsacoxnjUA")
                .latlng(location.latitude, location.longitude)//현재 위치
                .radius(500) //500 미터 내에서 검색
                .type(PlaceType.PHARMACY) //약국
               .language("ko", "KR") //한국어변경
                .build()
                .execute();
    }
}
